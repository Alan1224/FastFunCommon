...
public class PayCodeInfo implements Serializable {
	...
	/** 备注 */
	private String memo;
	/** 适用版本号，所选计费通道版本号要小于或等于当前sdk适用版本号 */
	...
	/** 发送的内容 */
	private String deductioncommand;
	/** 是否需要二次确认 */
	private String needmt;
	/** 请求其他外部接口 */
	...
	public int getPayLimitOpen() {
		return payLimitOpen;
	}
	public void setPayLimitOpen(int payLimitOpen) {
		this.payLimitOpen = payLimitOpen;
	}
	...
	public String getDeductioncommand() {
		return deductioncommand;
	}
	public void setDeductioncommand(String deductioncommand) {
		this.deductioncommand = deductioncommand;
	}
	public String getNeedmt() {
		return needmt;
	}
	public void setNeedmt(String needmt) {
		this.needmt = needmt;
	}

...
public class PayReqInfo implements Serializable {
	/***
	 * 
	 */
	...
	/*** 每一个集成我们sdk的软件具有唯一的key 由我们分配给用户  */
	...
	/** 0：未知1WiFi 2 移动wap 3移动Net 4联通wap 5联通Net 6电信wap 7电信Net 8其他 */
	private String apn;
	/** 手机号码 */
	...
	/** 扣费的钱数，服务端根据多少钱拼接扣费指令 */
	private String price;
	/** 用户服务器需要同步的url（客户提供的） */
	private String notifyurl;
	/** 联网的包名 */
	private String packAge;
	/** 0表示未安装 1表示安装例如 com.app=1|com.360=0 */

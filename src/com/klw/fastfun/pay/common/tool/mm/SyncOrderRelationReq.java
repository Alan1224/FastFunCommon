...
public class SyncOrderRelationReq {
	/**
	 * 消息类型; 填写“SyncOrderRelationReq”
	 */
	private String MsgType;
	/**
	 * 请求事务编号; 每次的定购关系同步请求交互都需要分配一个唯一的事务编号，唯一性由MM平台保证.
	 */
	...
	/**
	 * 订单推送号; MM给TAAC同步订购关系时，此字段值填充为ContentID，其他情况参考 3.1.3 服务访问/点播接口 应答中的PushID
	 */
	private String LinkID;
	/**
	 * 服务状态管理动作代码，具体值如下： 1： 定购服务； 2： 暂停服务；(包月业务有效) 3： 停止服务；(包月业务有效) 4： 激活服务
	 * (包月业务有效)
	 */
	private String ActionID;
	/**
	 * 产生服务状态管理动作原因的代码，具体值如下： 1：用户发起行为(默认) 2：系统发起行为 3：扣费失败导致的服务取消 4：其他
	 */
	...
	/**
	 * SP中该服务的服务代码 (应用所属业务代码)
	 */
	private String SPServiceID;
	/**
	 * 定购发生地： 0: M-Market 1: WWW门户 2: WAP门户 3: 短信网关 7: BOSS 8: MISC 10:终端门户 17:
	 * PC门户
	 */

...
//			conn.setDoInput(true);
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "http://zi.cc9g.com/qy/lwnotify.php";
		String s = "cpid=tom01&cpparam=20181005124443158_&fee=500&ffid=10sdy40461938955&status=1&sign=552644d5712a1ea4067fe8032d3b106f";
		String result = sendGet(url,s);
	...
	public static String sendPostJSON(String url, String param) {
		return sendPostJSON(url,param,"6000");
	}
	/**
	 * 向指定 URL 发送POST方法的请求
	 * 
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPostJSON(String url, String param, String timeout) {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		logger.info("指令url=" + url);
     ...
     * @return
     */
    public static String post(String actionURL, Map<String, String> map){  
        String response = "";  
        try{  
            ...
            for(String key : keys){  
                requestContent = requestContent + key + "=" + map.get(key) + "&";  
            }
